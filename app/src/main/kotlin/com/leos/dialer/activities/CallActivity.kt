...
import com.leos.commons.helpers.setWindowTransparency
import com.leos.commons.models.SimpleListItem
import com.leos.dialer.R
import com.leos.dialer.dialogs.DynamicBottomSheetChooserDialog
import com.leos.dialer.extensions.*
import com.leos.dialer.helpers.*
import com.leos.dialer.models.AudioRoute
...
class CallActivity : SimpleActivity() {
    ...
    private fun addLockScreenFlags() {
        ...
        try {
            ...
            screenOnWakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK, "com.leos.dialer:full_wake_lock")
    ...
    private fun enableProximitySensor() {
        if (!config.disableProximitySensor && (proximityWakeLock == null || proximityWakeLock?.isHeld == false)) {
            val powerManager = getSystemService(Context.POWER_SERVICE) as PowerManager
            proximityWakeLock = powerManager.newWakeLock(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK, "com.leos.dialer:wake_lock")
