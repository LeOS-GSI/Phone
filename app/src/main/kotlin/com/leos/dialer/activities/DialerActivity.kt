...
import com.leos.commons.helpers.REQUEST_CODE_SET_DEFAULT_DIALER
import com.leos.dialer.R
import com.leos.dialer.extensions.getHandleToUse
...
class DialerActivity : SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.action == Intent.ACTION_CALL && intent.data != null) {
            ...
            // make sure LeOS-Phone is the default Phone app before initiating an outgoing call
            if (!isDefaultDialer()) {
